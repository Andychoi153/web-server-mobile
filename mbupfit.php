...
<form method="POST" ENCTYPE="multipart/form-data" action="fitsol.php">
<iframe id="ifrm" src="mbupif.php" frameborder=0 width="100%" height ="100" scrolling=no border=50 ></iframe> 
            <tr>
